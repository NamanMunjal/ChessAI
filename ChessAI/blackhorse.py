	...
	def checkMoves(self):
		...
		try:
			if self.ordinates[0]-2 >= 0 and self.ordinates[1]+1 >=0:
				if self.board[self.ordinates[0]-2][self.ordinates[1]+1] == ' ' or self.board[self.ordinates[0]-2][self.ordinates[1]+1].startswith("W"):
		...
		try:
			if self.ordinates[1]-2 >= 0 and self.ordinates[0]-1 >=0:
				if self.board[self.ordinates[0]-1][self.ordinates[1]-2] == ' ' or self.board[self.ordinates[0]-1][self.ordinates[1]-2].startswith("W"):
