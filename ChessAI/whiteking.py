class whiteking():
	...
	def checkMoves(self):
		...
		if self.ordinates[0] != 0:
			try:
				#check front block
				if self.board[self.ordinates[0]-1][self.ordinates[1]] == ' ' or self.board[self.ordinates[0]-1][self.ordinates[1]].startswith("B"):
		...
		if self.ordinates[1] != 7:
			try:
				#check right block
				if self.board[self.ordinates[0]][self.ordinates[1]+1] == ' ' or self.board[self.ordinates[0]][self.ordinates[1]+1].startswith("B"):
		...
		try:
			...
			if self.ordinates[0]-1 != -1 and self.ordinates[1]+1 != -1:
				if self.board[self.ordinates[0]-1][self.ordinates[1]+1] == ' ' or self.board[self.ordinates[0]-1][self.ordinates[1]+1].startswith("B"):
